...
type ModelsTypeHeroProps = {
  section: CatalogSection;
  modelCount: number;
};

export const ModelsTypeHero = ({
  section,
  modelCount,
}: ModelsTypeHeroProps) => (
  <section className="px-4 pt-6">
    <div className="mx-auto max-w-6xl">
      ...
      >
        ...
        <span>/</span>
        <b className="font-medium text-zinc-200">{section.categoryLabel}</b>
      </nav>
