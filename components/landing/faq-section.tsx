...
const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "Нет. После регистрации мы дарим 100 ₽ на баланс — этого достаточно, чтобы попробовать все функции платформы. Когда баланс закончится, вы можете пополнить его или оформить подписку.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Подписка включает доступ ко всем 18+ AI-моделям от 6 провайдеров (OpenAI, Google, Anthropic, xAI, BFL, Recraft), генерацию изображений и видео, генерацию и выполнение кода, анализ документов, поиск в интернете и режим рассуждений. Вы получаете 3M токенов в месяц для всех функций.",
  },
  {
