...
const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Подписка включает доступ ко всем 18+ AI-моделям от 6 провайдеров (OpenAI, Google, Anthropic, xAI, BFL, Recraft), генерацию изображений и видео, генерацию кода, анализ документов, поиск в интернете и режим рассуждений. Каждый месяц на ваш баланс зачисляется 999 ₽ для всех функций.",
  },
  {
