...
export const metadata: Metadata = {
  ...
  description:
    "GIPITI — платформа с доступом к лучшим AI-моделям: GPT-5.6, Gemini 3.1 Pro, Claude Opus 5 и Grok 4.5. Генерация текста, изображений, видео, кода, анализ документов.",
  keywords: [
    "GIPITI",
    "Гипити",
    "гипити",
