  ...
  return (
    <div className="flex min-h-dvh w-screen items-start justify-center bg-background py-12 md:py-16">
      <div className="w-full max-w-3xl px-4">
        <h1 className="mb-2 font-bold text-2xl dark:text-zinc-50 md:text-3xl">
          {t("title")}
        </h1>
        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <dl className="space-y-3 text-sm">
              <div>
                <dt className="font-medium dark:text-zinc-200">{t("sections.definitions.service.term")}</dt>
                <dd className="text-muted-foreground">{t("sections.definitions.service.def")}</dd>
              </div>
              <div>
                <dt className="font-medium dark:text-zinc-200">{t("sections.definitions.user.term")}</dt>
                <dd className="text-muted-foreground">{t("sections.definitions.user.def")}</dd>
              </div>
              <div>
                <dt className="font-medium dark:text-zinc-200">{t("sections.definitions.subscription.term")}</dt>
                <dd className="text-muted-foreground">{t("sections.definitions.subscription.def")}</dd>
              </div>
              <div>
                <dt className="font-medium dark:text-zinc-200">{t("sections.definitions.executor.term")}</dt>
                <dd className="text-muted-foreground">{t("sections.definitions.executor.def")}</dd>
              </div>
            </dl>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-sm leading-relaxed">
              <div>
                <h3 className="mb-2 font-medium dark:text-zinc-200">{t("sections.rights.executor.title")}</h3>
              ...
              <div>
                <h3 className="mb-2 font-medium dark:text-zinc-200">{t("sections.rights.user.title")}</h3>
                <ul className="list-disc space-y-1 pl-5 text-muted-foreground">
