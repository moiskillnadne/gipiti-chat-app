          ...
          <section>
            ...
            <dl className="space-y-2 text-sm">
              <div className="grid gap-1 sm:grid-cols-3 sm:gap-4">
                <dt className="font-medium text-muted-foreground">{t("sections.controller.name")}</dt>
                <dd className="sm:col-span-2">{t("sections.controller.nameValue")}</dd>
              </div>
              <div className="grid gap-1 sm:grid-cols-3 sm:gap-4">
                <dt className="font-medium text-muted-foreground">{t("sections.controller.inn")}</dt>
                <dd className="sm:col-span-2">{t("sections.controller.innValue")}</dd>
              </div>
              <div className="grid gap-1 sm:grid-cols-3 sm:gap-4">
                <dt className="font-medium text-muted-foreground">{t("sections.controller.address")}</dt>
                <dd className="sm:col-span-2">{t("sections.controller.addressValue")}</dd>
              </div>
              <div className="grid gap-1 sm:grid-cols-3 sm:gap-4">
                <dt className="font-medium text-muted-foreground">{t("sections.controller.email")}</dt>
