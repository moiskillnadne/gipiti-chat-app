...
const LOGIN_SUCCESS_URL_REGEX = /\/(chat|settings)/;
...
export class LoginPage {
  ...
  async waitForLoginSuccess(): Promise<void> {
    await this.page.waitForURL(LOGIN_SUCCESS_URL_REGEX, {
