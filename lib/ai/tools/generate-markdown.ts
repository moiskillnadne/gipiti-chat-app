...
Prefer generatePdf or generateDocx when the user asks specifically for a PDF or Word document, generateTxt when they ask for a plain .txt file, and generateCsv for tabular data (CSV / a table for Excel). Do NOT use this tool when:
