...
export const anthropicLandings: ModelLanding[] = [
  {
    ...
    sub: "Сильнейшая модель Anthropic уже в GIPITI — глубокая аналитика, эталонная редактура и работа с большим контекстом. Без VPN, на русском, с оплатой российскими картами. Дарим 100 ₽ на баланс при регистрации.",
    ctaMain: "Попробовать Claude Opus 4.8",
    metaTitle: "Claude Opus 4.8 — нейросеть Claude на русском без VPN | GIPITI",
    metaDescription:
      "Claude Opus 4.8 — сильнейшая модель Anthropic в GIPITI: глубокая аналитика, редактура и большой контекст. Без VPN, на русском, оплата российскими картами. Дарим 100 ₽ при регистрации.",
    heroChat: {
      userMessage:
  ...
  },
  {
    ...
    sub: "Новое поколение сбалансированной модели Anthropic уже в GIPITI — быстрые рассуждения, сильная генерация кода и повседневные задачи. Без VPN, на русском, с оплатой российскими картами. Дарим 100 ₽ на баланс при регистрации.",
