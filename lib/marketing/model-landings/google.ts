...
export const googleLandings: ModelLanding[] = [
  {
    ...
    sub: "Флагманская модель Google уже в GIPITI — текст, изображения и документы в одном чате. Без VPN, на русском, с оплатой российскими картами. Дарим 100 ₽ на баланс при регистрации.",
    ctaMain: "Попробовать Gemini 3.1 Pro",
    metaTitle: "Gemini 3.1 Pro — нейросеть Google на русском без VPN | GIPITI",
    metaDescription:
      "Gemini 3.1 Pro — флагманская модель Google в GIPITI: текст, изображения и документы в одном чате. Без VPN, на русском, оплата российскими картами. Дарим 100 ₽ при регистрации.",
    heroChat: {
      userMessage:
  ...
  },
  {
    ...
    sub: "Быстрая модель Google уже в GIPITI — мгновенные ответы с рассуждениями по минимальной цене. Без VPN, на русском, с оплатой российскими картами. Дарим 100 ₽ на баланс при регистрации.",
    ...
    benefits: [
      ...
      },
      {
        ...
        text: "Одни из самых доступных запросов в GIPITI — стартовых 100 ₽ и ежемесячного баланса подписки хватает надолго.",
      },
      {
        icon: "sparkles",
