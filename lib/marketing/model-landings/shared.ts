...
export const DEEPSEEK_41_FLASH_SLUG = "deepseek-v4-1-flash";
...
export const GPT_IMAGE_25_FLARE_SLUG = "gpt-image-2-5-flare";
export const GPT_IMAGE_25_SUNBURST_SLUG = "gpt-image-2-5-sunburst";
